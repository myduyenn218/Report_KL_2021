...
\begin{itemize}
    ...
    \item Ở màn hình bản đồ, bạn có thể nhập hai địa điểm bắt đầu và địa điểm kết thúc bạn muốn đến, sau đó nhấn vào button "SHOW ROUTE" để tìm đường đi. Lúc này, khoảng cách và đường đi sẽ được hiển thị lên bản đồ.
\end{itemize}