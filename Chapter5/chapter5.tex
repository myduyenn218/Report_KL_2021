...
\subsection{Class Diagram hệ thống}

\subsection{Class Diagram trên thiết bị di động (mobile)}
\begin{figure}[H]
    \centering
    \includegraphics[width=15cm]{images/classdiagram.png}
    \caption{Hình Class Diagram trên thiết bị di động (mobile)}
    \label{fig:classdiagram} 
\end{figure}
Hình \ref{fig:classdiagram} thể hiện Class Diagram được xây dựng trên thiết bị di động. Các Class Diagram được thể hiện như sau:
