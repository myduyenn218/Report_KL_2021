...
\begin{figure}[htp]
    \centering
    \includegraphics[width=15cm]{images/trainingdata_dichtungtu.png}
...
Nhóm em sử dụng thư viện VNCoreNLP để tách từ và phân loại các từ trong câu. Sau đó dùng thư viện word2word để dịch những từ không thuộc từ loại  riêng. Những từ thuộc từ loại danh từ riêng được giữ nguyên tiếng Việt.
