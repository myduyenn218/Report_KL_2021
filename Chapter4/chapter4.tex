...
Trong hình dưới đây \ref{fig:benchmarks}, điểm F1 của cả phân loại ý định và trích xuất slot đã được tính toán cho một số nhà cung cấp NLU.
...
Nhóm em sử dụng thư viện VNCoreNLP để tách từ và phân loại các từ trong câu. Danh sách Pos Tags ở bảng \ref{fig:Part-Of-Speech (POS) tags} Sau đó dùng thư viện word2word để dịch những từ không thuộc từ loại  riêng. Những từ thuộc từ loại danh từ riêng được giữ nguyên tiếng Việt.
...
\begin{tabular}{|l|l|l|}
\hline
\multicolumn{3}{|c|}{\textbf{POS tags}}                                                                                                                                                                                                                                                                                                                                             \\ \hline
\begin{tabular}[c]{@{}l@{}}N   Danh từ\\ Np Danh từ riêng\\ Nc Danh từ phân loại\\ Nu Danh từ đơn vị\\ Ny Danh từ viết tắt\\ Nb Danh từ mượn\end{tabular} & \begin{tabular}[c]{@{}l@{}}V Động từ\\ Vb Động từ mượn\\ A Tính từ\\ P Đại từ\\ L Từ hạn định\\ M Lượng từ\end{tabular} & \begin{tabular}[c]{@{}l@{}}E Giới từ\\ C Liên từ\\ I Thán từ\\ S Phụ tố\\ X Khác\end{tabular} \\ \hline
\end{tabular}} 
\end{center}
\caption{Part-Of-Speech (POS) tags}
...
Sau khi dịch ta được bộ dữ liệu huấn luyện\footnote{Xem thêm về bộ huấn luyện \url{https://drive.google.com/file/d/1VSDhjrSghKtHmQxhWfC_x-qyOKDm3YuM/view?usp=sharing}} và bộ dữ liệu kiểm thử \footnote{Xem thêm về bộ kiểm thử \url{https://drive.google.com/file/d/1S631oRroP67z6LRwGSNwkrx-22c10baJ/view?usp=sharing}}, kết quả dịch được minh họa như hình \ref{fig:trainingdata-tudien}
\begin{figure}[htp]
    \centering
    \includegraphics[width=15cm]{images/trainingdata-tudien.png}
