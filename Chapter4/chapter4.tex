...
Hai thành phần chuyển giọng nói thành văn bản và chuyển văn bản thành giọng nói được thực hiện ở ứng dụng di động bằng cách sử dụng package speech\_to\_text \footnote{Xem thêm về SpeechToText \url{https://pub.dev/packages/speech_to_text}} và flutter\_tts \footnote{Xem thêm về TextToSpeech \url{https://pub.dev/packages/flutter_tts}} được cung cấp bởi bộ quản lý thư viện của Flutter.
