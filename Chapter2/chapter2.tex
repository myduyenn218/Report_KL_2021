...
Do sự tồn tại của nhiều dịch vụ \ac{nlu}, việc lựa chọn ra một nền tảng để sử dụng cũng rất khó khăn. Nhóm em lựa chọn nền tảng \ac{nlu} có hiệu năng cao để có thể đem lại kết quả tốt.

Nếu hiệu năng giữa các nền tảng thương mại và nền tảng mã nguồn mở không có sự chênh lệch nhiều, do đó, nhóm em ưu tiên lựa chọn nền tảng \ac{nlu} mã nguồn mở với các tiêu chí sau đây:
...
\begin{itemize}
    \item[--] Dựa trên kết quả các bài báo mà nhóm tham khảo. Nhóm em rút ra được rằng giữa các nền tảng \ac{nlu} khác nhau cho kết quả không giống nhau.
